...
AIFlash baseline code based on Restormer.
...
- Public dataset: https://huggingface.co/datasets/zsn1434/AI_Flash_Portrait/tree/main
- Competition page: https://www.codabench.org/competitions/12885/
Stage
Dataset
Status
Description
...
Training Set
✅ Available
Training images (input + GT pairs + person mask)
Stage 2
Test Set A
✅ Available (public, with GT)
Test images and GT publicly released on Hugging Face
Stage 3
Test Set B
✅ Available (public, with GT)
Test images and GT publicly released on Hugging Face
...
For other CUDA versions, please refer to PyTorch Official Website
...
--input_dir
✅
Input image directory or single image
--output_dir
❌
